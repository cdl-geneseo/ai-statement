...
Every office on campus should establish **clear expectations regarding acceptable use of GenAI in accomplishing the work of the office**, including when and how GenAI may be used appropriately (if it may be used at all). In the classroom, faculty should establish similar expectations regarding the use of GenAI to complete assignments and provide a **clear statement of these expectations on the course syllabus**. A good statement will **distinguish** between free-standing AI tools, such as chatbots, and those built into word-processors and other software, such as tools for checking grammar and spelling, suggesting word choices, or improving clarity. In establishing ground rules for the classroom, it's important to recognize how pervasive and sometimes inescapable this latter category of tools has become, and that the tools may not even disclose themselves as powered by GenAI. A blanket prohibition against the use of GenAI that lacks distinctions and does not provide detailed guidance will prove difficult if not impossible to enforce and will put students at risk of violating the prohibition unintentionally.
